...
<div class="info2">
  <h2 class="" style="padding-bottom: 15px; border-bottom: 1px solid #d2d2d2; margin-bottom: 20px;" >Transaksi</h2>
  <a href="tambah_transaksi.php" class="btn btn-primary" style="margin-bottom: 15px !important"><span class="fas fa-fw fa-plus"></span> Transaksi</a>
   ...
   <tbody>
    ...
    while($s = mysqli_fetch_array($show)) {
       ...
       <tr>
        ...
        <td>
        <a title="Print" target="_blank" href="print.php?id=<?= $s['kode_transaksi']; ?>" class="btn btn-primary"><span class="fas fa-fw fa-print"></span>Print</a> 
